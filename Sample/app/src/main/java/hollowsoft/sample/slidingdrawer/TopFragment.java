...
public class TopFragment extends BaseFragment implements OnDrawerOpenListener,
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View view = inflater.inflate(R.layout.top_fragment, viewGroup, false);

        final SlidingDrawer drawer = (SlidingDrawer) view.findViewById(R.id.top_fragment_sliding_drawer_top_drawer);
