...
public class LeftFragment extends BaseFragment implements OnDrawerOpenListener,
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup viewGroup, final Bundle bundle) {
        ...
        final View view = inflater.inflate(R.layout.left_fragment, viewGroup, false);

        final SlidingDrawer drawer = (SlidingDrawer) view.findViewById(R.id.left_fragment_sliding_drawer_left_drawer);
